...
export default [
  ...
  new Cell('chest', 'Chest', 'Сундук', 'Куфар', 2),
  ...
  new Cell('chance', 'Chance', 'Шанс', 'Шанец', 7),
  ...
  new Cell('jail', 'Jail', 'Тюрьма', 'Астрог', 10),
  ...
  new Cell('chest', 'Chest', 'Сундук', 'Куфар', 17),
  ...
  new Cell('chance', 'Chance', 'Шанс', 'Шанец', 22),
  ...
  new Cell('goToJail', 'Go To Jail', 'Идите в тюрьму', 'Ідзіце ў турму', 30),
  ...
  new Cell('chest', 'Chest', 'Сундук', 'Куфар', 33),
  ...
  new Cell('chance', 'Chance', 'Шанс', 'Шанец', 36),
